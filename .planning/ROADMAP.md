...
- [x] 34-02-PLAN.md — EXEC-05 wiring: async `confirm()` + `"process.exec"` Step-4.75 guard & Step-7 dispatch + inline-annotated `mint_from_exec` + async `main.rs` threading + cfg(linux) D-11 acceptance test (EXEC-05)

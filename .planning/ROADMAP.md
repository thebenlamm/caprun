...
- [ ] 06-02-PLAN.md — executor: refine blocking predicate over is_untrusted() (HARD-02) + allow/regression tests [wave 2]
- [ ] 06-03-PLAN.md — broker: mint_from_intent + intent_received event + ProvideIntent/IntentAccepted IPC + dispatch (PLAN-04) [wave 2]
